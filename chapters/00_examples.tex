...
Hier steht interessanter Text mit Quelle. \cite{example_citation} \todo{hier ist ein TODO} Mehr toller Text. Damit die Quelle beim Text bleibt verwende ich das (siehe LaTeX Editor): ~\cite{example_citation} 
